...
question_forwarder = QuestionForwarder(
    max_context_tokens=15000,
)
question_forwarder.set_additional_instruction("""
...
3. Ask the Chart Assistant to Make a line chart to display all different types of expenses.
4. Ask the Diagram Assistant to create a gantt chart to show the timeline of the shipment.
""")
shipment_analyzer_assistant = AssistantOrchestra(
    llm_question_forwarder=question_forwarder,
)
shipment_analyzer_assistant.agents = {
...
app = create_chat_backend(shipment_analyzer_assistant)    
