...
from QuestionRewrite import QuestionRewrite
...
question_rewrite = QuestionRewrite(url='http://10.13.13.4:11434/api/generate')
...
assistant.set_question_rewrite(question_rewrite)
