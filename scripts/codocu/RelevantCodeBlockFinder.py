...
class RelevantCodeBlockFinder:
    def __init__(self, url: str = 'http://localhost:11434/api/generate', model: str = 'gemma2:9b-instruct-q8_0'):
        ...
        self.model = model
        self.base_prompt = """
        You are an experienced software developer and you are asked to extract only the relevant code block from a document that answers a user question.
        Important: Just return code block as is, do not include any additional information, no explaination, no prompt.
        Document:
        {document}
        Question: {question}
