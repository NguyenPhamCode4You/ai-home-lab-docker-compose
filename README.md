...
create table n8n_documents_agentic_neo (
...
CREATE FUNCTION match_n8n_documents_agentic_neo (
...
BEGIN
  ...
  SELECT
    ...
    summarize,
    metadata,
    2 - ((n8n_documents_agentic_neo.embedding <=> query_embedding) + (n8n_documents_agentic_neo.embedding2 <=> query_embedding)) AS similarity
  FROM n8n_documents_agentic_neo
