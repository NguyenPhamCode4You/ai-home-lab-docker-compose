...
class Ollama:
    def __init__(self, url: str = None, model: str = None, num_ctx: int = None, num_predict: int = None, think: bool = False):
    ...
    async def stream(self, prompt: str):
        ...
        async with httpx.AsyncClient(timeout=httpx.Timeout(80.0)) as client:
            async with client.stream("POST", f"{self.url}/api/generate", json={
                "model": self.model, 
                "prompt": prompt, 
                "think": self.think, 
                "options": {
