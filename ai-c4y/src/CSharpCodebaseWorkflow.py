...
The implementation has been split into focused phase files:
  ...
  src/cia_phase_workflow_identify.py    — identify_critical_workflows (reverse-engineer index → discovered-workflows.json)
...
from .cia_phase_workflow_identify import identify_critical_workflows  # noqa: F401
