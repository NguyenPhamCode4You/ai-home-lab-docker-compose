#!/usr/bin/env python3
"""
AI Code Review Tool for GitLab - Standard Review
...
def main():
    """Main entry point for standard code review"""
    parser = argparse.ArgumentParser(description='AI Code Review Tool for GitLab - Standard Review')
    ...
    try:
        ...
        # Perform standard review with custom guidelines if provided
